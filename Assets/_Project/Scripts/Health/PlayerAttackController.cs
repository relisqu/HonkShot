...
namespace Scripts.Health
{
    public class PlayerAttackController : AttackController
    {
        ...
        [ShowIf("_dependsOnSpeed")][SerializeField] private float _minBonusCoeffSpeed;
        [ShowIf("_dependsOnSpeed")][SerializeField] private float _maxBonusCoeffSpeed;
        [ShowIf("_dependsOnSpeed")][SerializeField] private float _maxSpeedCoeff = 2f;
